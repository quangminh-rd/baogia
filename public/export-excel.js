document.getElementById('export-excel').addEventListener('click', async function () {
    ...
    try {
        ...
        if (orderDetails.donviPhutrach === "BP. BH1" && orderDetails.phuongThucban === "Bán đại lý") {
            ...
            worksheet.getCell('A525').value = ' - Bảo hành 1 năm cho phụ kiện lắp đồng bộ với cửa: tay nắm kèm khóa, động cơ của cuốn, điều khiểu, vật tư nhựa.';
            worksheet.getCell('A526').value = ' - Bảo hành 1 năm sản phẩm cửa rèm tổ ong.';
            worksheet.getCell('A527').value = ' - Bảo hành 2 năm sản phẩm cửa lưới sợi thủy tinh; cửa lưới PET-Polyester; cửa lưới PL-Polyester.';
            worksheet.getCell('A528').value = ' - Bảo hành 3 năm sản phẩm cửa  sử dụng lưới Inox - lưới thép.';
        } else {
            worksheet.getCell('A521').value = '3. Giá trên có hiệu lực 7 ngày kể từ ngày phát hành.';
