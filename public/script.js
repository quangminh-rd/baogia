...
function processFoundData(orderDetails) {
    ...
    const formattedSotien = formatNumber(orderDetails.sotienConthieu || '0');
    ...
    // Hiển thị hoặc ẩn nội dung thanh toán
    const paymentContent2 = document.getElementById('payment-content-2');
    if (paymentContent2) {
        paymentContent2.style.display =
            orderDetails.donviPhutrach !== "BP. BH1" && orderDetails.donviPhutrach !== "BP. BH2" && orderDetails.thongtinThanhtoan !== ""
                ? 'block'
                : 'none';
    }
}
        ...
        htmlContent = `
                                   <tbody>
                                    ...
                                    <tr>
                                        <td class="infocol-1"><i>Địa chỉ:</i></td>
                                        <td class="infocol-2">${diachiChitiet}</td>
                                        <td class="infocol-3"><i>Đơn vị phụ trách:</i></td>
                                        <td class="infocol-4">${donviPhutrach}</td>
                                    </tr>
                                    <tr>
                                        <td class="infocol-1"><i>SĐT:</i></td>
